...
import com.example.plantapp.databinding.FragmentDeliveryOrderBinding
...
class DeliveryOrderFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.apply {
            ...
            orderDeliveryFragment = this@DeliveryOrderFragment
            viewModel = sharedViewModel
        }
    }
    ...
    fun goToNextScreen() {
        ...
        findNavController().navigate(R.id.action_deliveryOrderFragment_to_checkoutFragment)
    }
    ...
    fun cancelOrder() {
        ...
        findNavController().navigate(R.id.action_deliveryOrderFragment_to_plantOrderFragment)
